...
basic_blockbb1:                                   ; preds = %basic_blockbb0
  ...
  call void @"rc_retain<Expr<>>"(%"Expr<>"** %expr0)
...
basic_blockbb4:                                   ; preds = %basic_blockbb3
  ...
  call void @"rc_retain<Expr<>>"(%"Expr<>"** %expr1)
...
basic_blockbb7:                                   ; preds = %basic_blockbb6
  ...
  call void @"rc_retain<Expr<>>"(%"Expr<>"** %tmp8)
...
basic_blockbb10:                                  ; preds = %basic_blockbb9
  ...
  call void @"rc_release<Expr<>>"(%"Expr<>"** %tmp8)
  call void @"rc_release<Expr<>>"(%"Expr<>"** %expr1)
  call void @"rc_release<Expr<>>"(%"Expr<>"** %tmp4)
  call void @"rc_release<Expr<>>"(%"Expr<>"** %expr0)
...
basic_blockbb5:                                   ; preds = %basic_blockbb8, %basic_blockbb4
  call void @"rc_release<List<>>"(%"List<>"** %ret)
