...
basic_blockbb0:
  ...
  %tmp13 = alloca i1
  %x = alloca i64
  %fcall = call %opaque @"Option::Some<int>"(i64 88)
  store %opaque %fcall, %opaque* %tmp1
  br label %basic_blockbb1

basic_blockbb1:                                   ; preds = %basic_blockbb0
  %load = load %opaque, %opaque* %tmp1
  %fcall14 = call %opaque.0 @"Either::Left<Option<int>,int>"(%opaque %load)
  store %opaque.0 %fcall14, %opaque.0* %tmp
  br label %basic_blockbb2

basic_blockbb2:                                   ; preds = %basic_blockbb1
  %load15 = load %opaque.0, %opaque.0* %tmp
  store %opaque.0 %load15, %opaque.0* %e
  br label %basic_blockbb3

basic_blockbb3:                                   ; preds = %basic_blockbb2
  store i1 true, i1* %tmp2
  %discr_gep = getelementptr inbounds %opaque.0, %opaque.0* %e, i32 0, i32 0
  ...
  %struct_gep = getelementptr inbounds %opaque.0, %opaque.0* %e, i32 0, i32 1
  %lvalue_pointer_cast = bitcast { i64 }* %struct_gep to { %opaque }*
  %struct_gep19 = getelementptr inbounds { %opaque }, { %opaque }* %lvalue_pointer_cast, i32 0, i32 0
  %load20 = load %opaque, %opaque* %struct_gep19
  store %opaque %load20, %opaque* %opt
...
basic_blockbb5:                                   ; preds = %basic_blockbb3
  ...
  %discr_gep22 = getelementptr inbounds %opaque.0, %opaque.0* %e, i32 0, i32 0
  ...
  %struct_gep29 = getelementptr inbounds %opaque.0, %opaque.0* %e, i32 0, i32 1
...
basic_blockbb8:                                   ; preds = %basic_blockbb4
  ...
  %discr_gep34 = getelementptr inbounds %opaque, %opaque* %opt, i32 0, i32 0
  ...
  %struct_gep41 = getelementptr inbounds %opaque, %opaque* %opt, i32 0, i32 1
...
basic_blockbb10:                                  ; preds = %basic_blockbb8
  ...
  %discr_gep46 = getelementptr inbounds %opaque, %opaque* %opt, i32 0, i32 0
...
define %opaque.0 @"Either::Left<Option<int>,int>"(%opaque %0) {
basic_blockbb0:
  %retvar = alloca %opaque.0
  %1 = alloca %opaque
  store %opaque %0, %opaque* %1
  ...
  %enum_ptr_cast = bitcast { i64 }* %enum_gep to { %opaque }*
  %load = load %opaque, %opaque* %1
  %enum_content_gep = getelementptr inbounds { %opaque }, { %opaque }* %enum_ptr_cast, i32 0, i32 0
  store %opaque %load, %opaque* %enum_content_gep
