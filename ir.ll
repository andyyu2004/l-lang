...
basic_blockbb1:                                   ; preds = %basic_blockbb0
  ...
  %fcall19 = call %"List<>"* @"last2<>"(%"List<>"* %load18)
...
basic_blockbb3:                                   ; preds = %basic_blockbb1
  ...
  %load_discr19 = load i16, i16* %discr_gep18
  store i16 %load_discr19, i16* %tmp4
  %load20 = load i16, i16* %tmp4
  %extend_discr21 = zext i16 %load20 to i64
  %icmp_eq22 = icmp eq i64 1, %extend_discr21
  store i1 %icmp_eq22, i1* %tmp5
  %load23 = load i1, i1* %tmp5
  %load24 = load i1, i1* %tmp3
  %and25 = and i1 %load23, %load24
  store i1 %and25, i1* %tmp3
