...
basic_block1:                                     ; preds = %basic_block0
  ...
  %load2 = load i64, i64* %load_deref1
  store i64 %load2, i64* %retvar
  %free_cast = bitcast i64*** %ptr to i8*
  %load_box3 = load i64**, i64*** %ptr
  %rc_cast4 = bitcast i64** %load_box3 to <{ i64*, i32 }>*
  %rc5 = getelementptr inbounds <{ i64*, i32 }>, <{ i64*, i32 }>* %rc_cast4, i32 0, i32 1
  call void @rc_release(i8* %free_cast, i32* %rc5)
...
basic_block1:                                     ; preds = %basic_block0
  ...
  %free_cast = bitcast i64**** %tmp to i8*
  ...
  call void @rc_release(i8* %free_cast, i32* %rc7)
  %free_cast8 = bitcast i64**** %retvar to i8*
  ...
  call void @rc_release(i8* %free_cast8, i32* %rc11)
  %load_ret = load i64***, i64**** %retvar
  ret i64*** %load_ret
}
...
basic_block0:
  ...
  call void @rc_release(i8* %free_cast, i32* %rc10)
  %free_cast11 = bitcast i64** %tmp to i8*
  ...
  call void @rc_release(i8* %free_cast11, i32* %rc14)
  %free_cast15 = bitcast i64** %retvar to i8*
  ...
  call void @rc_release(i8* %free_cast15, i32* %rc18)
  %load_ret = load i64*, i64** %retvar
  ret i64* %load_ret
}
