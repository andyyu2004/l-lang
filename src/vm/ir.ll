...
basic_block0:
  ...
  %fcall = call double @fac(double 1.000000e+00)
...
basic_block3:                                     ; preds = %basic_block2, %basic_block0
...
basic_block4:                                     ; preds = %basic_block3, %basic_block1
  %load_ret = load double, double* %retvar
  ret double %load_ret
}
...
basic_block0:
  ...
  switch i1 %fcmp_lt, label %basic_block4 [
    i1 true, label %basic_block1
  ]
...
basic_block4:                                     ; preds = %basic_block3, %basic_block0
...
basic_block5:                                     ; preds = %basic_block4, %basic_block1
  %load_ret = load double, double* %retvar
  ret double %load_ret
}
